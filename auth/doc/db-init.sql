...
--   Create Database
-- =====================================
CREATE DATABASE IF NOT EXISTS auth_common
    CHARACTER SET utf8mb4
    COLLATE utf8mb4_unicode_ci;

USE ledgerx;

CREATE TABLE auth_realm (
    id BIGINT NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
    realm_code VARCHAR(100) NOT NULL COMMENT 'Unique realm identifier, e.g. ledgerx, learntogether',
    realm_name VARCHAR(255) NOT NULL COMMENT 'Display name',
    description VARCHAR(1000) NULL COMMENT 'Optional description',
...
ON UPDATE CURRENT_TIMESTAMP(3),
    ...
    PRIMARY KEY (id),
    UNIQUE KEY uk_auth_realm_realm_code (realm_code),
    KEY idx_auth_realm_status (status)
) ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_unicode_ci
COMMENT='Authentication user pools / realms';


CREATE TABLE auth_client (
 id BIGINT NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
 client_id VARCHAR(100) NOT NULL COMMENT 'Public client identifier, e.g. learntogether-web',
 client_name VARCHAR(255) NOT NULL COMMENT 'Display name',
 realm_id BIGINT NOT NULL COMMENT 'FK to auth_realm.id',
 description VARCHAR(1000) NULL COMMENT 'Optional description',
 client_type VARCHAR(30) NOT NULL DEFAULT 'PUBLIC' COMMENT 'PUBLIC / CONFIDENTIAL / INTERNAL',
 client_secret_hash VARCHAR(255) NULL COMMENT 'Only used for confidential clients',
 access_token_ttl_seconds INT NOT NULL DEFAULT 3600 COMMENT 'Access token expiration time',
 refresh_token_ttl_seconds INT NOT NULL DEFAULT 2592000 COMMENT 'Refresh token expiration time',
 allowed_scopes VARCHAR(1000) NULL COMMENT 'Comma separated scopes, e.g. openid,profile,email',
 status VARCHAR(20) NOT NULL DEFAULT 'ACTIVE' COMMENT 'ACTIVE / INACTIVE',
 created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
 updated_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
 PRIMARY KEY (id),
 UNIQUE KEY uk_auth_client_client_id (client_id),
 KEY idx_auth_client_realm_id (realm_id),
 KEY idx_auth_client_status (status),
 CONSTRAINT fk_auth_client_realm
     FOREIGN KEY (realm_id)
         REFERENCES auth_realm(id)
) ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_unicode_ci
COMMENT='Authentication clients mapped to a realm';
-- =====================================
--   USER TABLE
-- =====================================
